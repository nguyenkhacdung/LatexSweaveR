...
<<echo=F,message=F, warning=F>>=
      library(ggplot2)
      library(dplyr)
load(file = "WorkingSpace.Database2010-2015.Rdata.RData")
@
%-------------------------------------------------------------
%     Table of Content               
%-------------------------------------------------------------
...
\begin{itemize}
  ...
  \item Antibiotic vs Non-antibiotic Distribution
  \item Skin ADR vs Non-skin ADR distribution
\end{itemize}
   \end{block}
